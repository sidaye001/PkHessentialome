...
####To scale the HMS median before plotting
#filtered.Go.modified0$median_HMS <- ifelse(filtered.Go.modified0$median_HMS<0.26,0,filtered.Go.modified0$median_HMS)
